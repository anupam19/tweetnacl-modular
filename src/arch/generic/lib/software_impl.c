...
static int crypto_core_salsa20_generic(u8 *out, const u8 *in, const u8 *k, const u8 *c) {
...
static int crypto_core_hsalsa20_generic(u8 *out, const u8 *in, const u8 *k, const u8 *c) {
    u32 w[16], x[16], t[4];
    int i, j, m;

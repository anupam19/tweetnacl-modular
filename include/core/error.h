 ...
 */
static inline int nacl_is_success(nacl_error_t err) { return (err == NACL_SUCCESS) ? 1 : 0; }
 ...
 */
static inline int nacl_is_error(nacl_error_t err) { return (err != NACL_SUCCESS) ? 1 : 0; }
